...
```{r}
modelhkw1 <- glm(TV_Trust ~ educated + age + male + married + trusting + income, data = hkwave1, family = "binomial")
tidy(modelhkw1)
```

```{r}
modeljw1 <- glm(TV_Trust ~ educated + age + male + married + trusting + income, data = japanwave1, family = "binomial")
tidy(modeljw1)
```
